...
const MENU_POR_ROL = {
  estudiante: [
    { label: "Área Personal", to: "/" },
    { label: "Matrícula Regular", to: "/matricula/solicitar" },
    { label: "Rendimiento Semestral", to: "/notas/mi-hoja" },
    { label: "Historial de Estudios", to: "/record-academico/mi-historial" },
    { label: "Trámites y Solicitudes", to: "/certificados/solicitar" },
  ],
  docente: [
    { label: "Módulo del Catedrático", to: "/" },
    { label: "Cursos Asignados", to: "/cursos-docentes/mis-cursos" },
    { label: "Calificación de Alumnos", to: "/notas/registrar" },
  ],
  administrador: [
    { label: "Administración General", to: "/" },
    { label: "Control de Inscripciones", to: "/matricula/listar" },
    { label: "Horarios y Secciones", to: "/cursos-docentes/asignar" },
    { label: "Cierre de Actas Oficiales", to: "/notas/gestionar" },
    { label: "Expedición de Documentos", to: "/certificados/listar" },
    { label: "Reportes Consolidados", to: "/record-academico/reportes" },
    { label: "Auditoría de Accesos", to: "/administracion/usuarios" },
  ],
  direccion: [
    { label: "Panel de Dirección", to: "/" },
    { label: "Estadísticas de Nuevos Alumnos", to: "/matricula/estadisticas" },
    { label: "Supervisión de Carga Horaria", to: "/cursos-docentes/carga-docente" },
    { label: "Reporte de Calificaciones", to: "/notas/gestionar" },
    { label: "Aprobación de Trámites", to: "/certificados/listar" },
    { label: "Análisis de Rendimiento", to: "/record-academico/reportes" },
    { label: "Trazabilidad y Auditoría", to: "/administracion/auditorias" },
  ],
};
